...
export const Callout: React.FC<CalloutProps> = (props) => {
    return (
        <div className="flex items-start justify-start p-4 my-8 space-x-3 border rounded-md section bg-slate-100 dark:bg-slate-900 border-slate-200 dark:border-slate-600">
